      ...
      <section className="file-section">
        <header className="section-head">
          ...
          {status.unstaged.length > 0 && (
            <button className="text-btn" onClick={() => run(window.gitApi.stageAll())}>
              Stage all
            </button>
          )}
        </header>
        <div className="file-list">
          ...
          {status.unstaged.length === 0 && <div className="empty-hint">No unstaged changes</div>}
        </div>
      </section>
      ...
      <section className="file-section">
        <header className="section-head">
          ...
          {status.staged.length > 0 && (
            <button className="text-btn" onClick={() => run(window.gitApi.unstageAll())}>
              Unstage all
            </button>
          )}
        </header>
        <div className="file-list">
          ...
          {status.staged.length === 0 && <div className="empty-hint">Nothing staged</div>}
        </div>
      </section>
